...
public class Constants {
    ...
    private static final String OPEN_SANS_LIGHT_HEBREW 	 = "OpenSansHebrew-Light.ttf";
    ...
    public static final Typeface openSansLightHebrew = Typeface.createFromAsset(ImageSearchApplication.getAppContext().getAssets(),Constants.OPEN_SANS_LIGHT_HEBREW);
